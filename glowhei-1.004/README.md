...
```sh
make -C ../sbitgraft-1.004
../sbitgraft-1.004/sbitgraft --strip GlowHei-GBK.ttc GlowHei-GBK-nohint.ttc
```
...
那 30 个多一层要求：它们不只是占满一格，还要接得上——连排画框时竖线必须跨行相
